    ...
    <section id ="about" className="about about-container">
      <div className="about-content">
        <div>
          ...
          <h4 className="about-text"><span role="img" aria-label="hi">👩🏻‍🎨</span> I’m a product designer with a passion for using collaborative approaches to integrate diverse perspectives to the product innovation process</h4>
