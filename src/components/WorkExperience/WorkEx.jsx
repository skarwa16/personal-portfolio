...
import BeatlyBanner from '../../assets/Beatly/Banner.png'
        ...
        <div className="portfolio-container">
          <div className="row-1">
            <div className="image-container">
              <a href="/beatly"><img src={BeatlyBanner} alt="Beatly Project Banner"></img>
              <h2 className="image-child project-heading">Beatly: Lyrics vs Beats</h2>
              <h4 className="image-child project-description">Curating music based on a user's preference for the lyrics or beats of a song</h4>
              </a>
            </div>
            <div className="image-container">
          ...
          <div className="row-1">
            <div className="image-container">
                <a href="/webControl">
                  <img src={WebControlBanner} alt="Web Control of Real Time Systems"></img>
                  <h2 className="image-child project-heading">Web Control of Real Time Systems</h2>
                  <h4 className="image-child project-description">Creating a Web application that facilitates two-way communication with Raspberry Pis on Mako Servers</h4>
                </a>
              </div>
          </div>
        </div>
